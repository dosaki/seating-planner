...
const colours = {
    "#24682c": ["#d4ffd4", "#102e13", "#2b2b2b", "#b3b3b3"],
    "#51bad2": ["#d4f1ff", "#002f46", "#2b2b2b", "#b3b3b3"],
    "#800102": ["#ffd4d4", "#4d0101", "#2b2b2b", "#b3b3b3"],
    "#c70203": ["#fe9192", "#6f0001", "#2b2b2b", "#b3b3b3"],
    "#ea87b0": ["#f5c4d8", "#5e1031", "#2b2b2b", "#b3b3b3"],
    "#c30165": ["#ffafd9", "#4d0028", "#2b2b2b", "#b3b3b3"],
    "#760086": ["#dbaaff", "#4d1a45", "#2b2b2b", "#b3b3b3"],
    "#ffdd1f": ["#ffeb7c", "#b29700", "#2b2b2b", "#b3b3b3"],
    "#636edd": ["#aab0ed", "#0f1444", "#2b2b2b", "#b3b3b3"],
};

const lipColours = {
    male: ["#e5bc89", "#d4903b"],
    female: Object.keys(colours)
};
...
const frontHair = {
    ...
    female: [
        "M 150,135 V 100 C 150,80 130,65 100,65 70,65 50,80 50,100 v 35 c 25,0 50,-5 50,-30 0,25 25,30 50,30 z",
        "M 150,135 V 100 C 150,80 130,65 100,65 70,65 50,80 50,100 v 35 z",
        "M 100,105 c 15,15 5,25 15,35 10,10 35,15 45,-5 5,-20 5,-45 -15,-65 C 130,55 110,40 95,55 90,60 90,65 80,60 55,45 10,125 60,155 c -10,-20 5,-40 20,-40 10,0 15,-5 20,-10 z"
    ]
};
const hairbob = [
...
const baseClothes = {
    ...
    female: [
        "M 150,310 10,-35 C 185,270 200,245 195,220 L 135,200 C 125,210 120,215 100,215 80,215 75,210 65,200 L 5,220 C 0,245 15,270 40,275 l 10,35 C 50,355 150,355 150,310 Z",
...
const cleavage = "M 65,200 c 5,5 5,5 5,10 5,10 10,15 10,25 15,5 10,10 20,10 10,0 5,-5 20,-10 0,-10 5,-15 10,-25 0,-5 0,-5 5,-10 z";
...
export const makePortrait = (gender, mood) => {
    const hairColour = pick(...hairColours);
    const skinColour = pick(...skinColours);
...
const makeBackHair = (gender, colour) => {
    ...
    if (gender === "female" && pick(true, true, false)) {
        portrait.push({ path: pick(...backHair), colour });
    }
};
...
const makeClothes = (gender, skinColour, lipColour) => {
    const accentColour = gender === "male" || pick(true, false) ? pick(...Object.values(colours)) : lipColour;
    const clothesColour = gender === "male" ? pick(...colours[accentColour].slice(1)) : pick(...colours[accentColour]);
    const shirtColour = colours[accentColour][0];
    const tieColour = pick(accentColour, ...pick(...Object.values(colours)));
    ...
    const hasCleavage = gender === "female" && !hasTie && pick(true, false);
    ...
    if (hasCleavage) {
        clothes.push({ path: cleavage, colour: skinColour });
        clothes.push({ path: lace, colour: accentColour });
    }
    if (hasChoker) {
        clothes.push({ path: collar, colour: accentColour });
    }
    return clothes;
};